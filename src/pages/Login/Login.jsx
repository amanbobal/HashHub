        ...
        >
          ...
          <form className="mx-4 sm:mx-6" onSubmit={handleSubmit}>
            ...
            {Object.keys(errors).length > 0 && (
              <motion.div
                className="text-center text-red-400 font-medium mb-4 rounded-md bg-red-100/10 px-3 py-2 border border-red-500/30"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
              ...
              <input
                ...
                className={`p-2 bg-transparent text-white border ${errors.email ? 'border-red-500' : 'border-gray-600'} rounded-md focus:border-teal-400 outline-none transition-all duration-300`}
              />
              {errors.email && (
            ...
            >
              <label className="my-2 font-semibold text-gray-200" htmlFor="password">
                Password
              </label>
              <input
                ...
                onChange={handleChange}
                className={`p-2 bg-transparent text-white border ${errors.password ? 'border-red-500' : 'border-gray-600'} rounded-md focus:border-teal-400 outline-none transition-all duration-300`}
              />
              <button
                type="button"
